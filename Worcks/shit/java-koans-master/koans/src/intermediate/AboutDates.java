...
public class AboutDates {
    ...
    public void dateToString() {
        assertEquals(date.toString(), "Sat Mar 03 15:33:21 MSK 1973"); // toString Преобразует вызывающий объект date в строку и возвращает результат.
    }
    ...
    public void changingDateValue() {
        ...
        assertEquals(date.toString(), "Sat Mar 03 16:33:21 MSK 1973");
    }
    ...
    public void usingCalendarToChangeDates() {
        ...
        assertEquals(cal.getTime().toString(), "Tue Apr 03 16:33:21 MSK 1973");
    }
    ...
    public void usingRollToChangeDatesDoesntWrapOtherFields() {
        ...
        assertEquals(cal.getTime().toString(), "Sat Mar 03 16:33:21 MSK 1973");
    }
    ...
    public void usingDateFormatToParseDates() throws ParseException {
        ...
        assertEquals(date2.toString(), "Sat Jan 01 00:00:00 MSK 2000");
